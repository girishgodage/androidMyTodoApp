...
import com.giri.mytodoapp.Reminder.ReminderActivity;

import java.util.UUID;

public class TodoNotificationService extends IntentService {
    public static final String TODOTEXT = "com.girish.todonotificationservicetext";
    public static final String TODOUUID = "com.girish.todonotificationserviceuuid";
